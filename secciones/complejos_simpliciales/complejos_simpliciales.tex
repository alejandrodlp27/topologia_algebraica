...
\begin{figure}[h!]%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% FIGURE
  \centering
%  \includegraphics[scale=0.11]{subdivision_baricentrica}
\end{figure}%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

Una de las propiedades m\'as importantes de la subdivisi\'on baric\'entrica es:

\import{\directory}{ejercicios/56} %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% EJERCICIO 56
...
\begin{figure}[h!]%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% FIGURE
  \centering
%  \includegraphics[scale=0.11]{iteracion_subdivision_baricentrica}
\end{figure}%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\import{\directory}{ejercicios/58} %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% EJERCICIO 58
...
\subsection{Complejos de cadena}%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% SUBSECTION
...
\import{\directory}{ejercicios/57} %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% EJERCICIO 57
...
\import{\directory}{ejercicios/59} %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% EJERCICIO 59
...
\import{\directory}{ejercicios/60} %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% EJERCICIO 60
